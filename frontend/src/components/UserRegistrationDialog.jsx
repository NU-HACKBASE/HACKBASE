...
export function UserRegistrationDialog({ error, isSubmitting, onSubmit, open }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/80 px-4 backdrop-blur-sm">
      ...
      >
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-normal" id="user-registration-title">
          ユーザー登録
        </h1>
        ...
        <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
          <label className="block">
            <span className="text-sm font-semibold text-slate-200">ユーザー名</span>
            <input
              autoFocus
